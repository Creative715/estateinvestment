                ...
                <div class="box-width-lg-470">
                    ...
                    <div class="tabs-custom tabs-horizontal tabs-line tabs-line-big tabs-line-style-2 text-center text-md-left" id="tabs-7">
                        <ul class="nav nav-tabs">
                            <li class="nav-item" role="presentation"><a class="nav-link active" href="#tabs-7-1" data-toggle="tab">Досвід</a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-7-2" data-toggle="tab">Вибір</a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-7-3" data-toggle="tab">Ціна</a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="tabs-7-1">
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsum, minima excepturi consequuntur minus fugiat dicta quos expedita voluptatem!</p>
                                <div class="group-md group-middle"><a class="button button-secondary button-pipaluk" href="#contact">Докладніше</a></div>
                            </div>
                            <div class="tab-pane fade" id="tabs-7-2">
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi architecto illo sit recusandae commodi asperiores doloribus itaque, nihil!</p>
                                <div class="group-md group-middle"><a class="button button-secondary button-pipaluk" href="#contact">Докладніше</a></div>
                            </div>
