                ...
                <div class="rd-navbar-aside">
                    ...
                    <div class="rd-navbar-panel">
                        ...
                        <div class="rd-navbar-brand">
                            <!--Brand--><a class="brand" href="{{ url('/') }}"><h4><img
                ...
                <div class="rd-navbar-main">
                    <div class="rd-navbar-nav-wrap">
                        ...
                        <ul class="rd-navbar-nav">
                            ...
                            <li class="rd-nav-item {{ $categoryLink }}"><a class="rd-nav-link"
                                                                           href="{{ route('category') }}">Категорії
                                    об'єктів</a>
                            </li>
                            <li class="rd-nav-item {{ $cityLink }}"><a class="rd-nav-link" href="{{ route('city') }}">Нерухомість
                                    у
                                    містах</a>
                            </li>
