                        ...
                        <ul class="rd-navbar-corporate-contacts">
                            <li>
                                <div class="unit unit-spacing-xs">
                                    <div class="unit-body">
                                        <a class="link-phone" href="tel:+380684314321"><h4><i class="fas fa-phone"></i>
                                                +38(068)431-43-21</h4></a>
                                        <div class="my-md-2"></div>
                                        <a class="link-phone" href="tel:+48575707823"><h4><i class="fas fa-phone"></i>
                                                +48(575)70-78-23</h4></a>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="unit unit-spacing-md">
                                    <div class="unit-body">
                                        <div class="row">
                                            <div class="col col-md-12"><a class="link-phone" target="_blank"
                                                                          href="viber://chat?number=48575707823">
                                                    <h4><img src="{{ asset('/images/viber.png') }}"
                                                             alt="нерухомість у польщі ціни"></h4></a></div>
                                            <div class="my-md-3"></div>
                                            <div class="col col-md-12"><a class="link-phone" target="_blank"
                                                                          href="https://api.whatsapp.com/send?phone=48575707823">
                                                    <h4><img src="{{ asset('/images/whatsapp.png') }}"
                                                             alt="оренда квартири у польщі"></h4></a></div>
                                        </div>
                                    </div>
                                </div>
                            </li>
                ...
                <div class="rd-navbar-main">
                    <div class="rd-navbar-nav-wrap">
                        <ul class="list-inline list-inline-md">
                            ...
                            <li><a target="_blanck" href="https://www.instagram.com/estateinvestment/"><i style="color: #fff;" class="fab fa-instagram fa-2x"></i></a></li>                        </ul>
                        <ul class="rd-navbar-nav">
                            ...
                            <li class="rd-nav-item"><a class="rd-nav-link" href="#city">Нерухомість у містах</a>
                            </li>
